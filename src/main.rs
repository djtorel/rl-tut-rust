...
impl Object {
    pub fn new(x: i32, y: i32, char: char, name: &str, color: Color, blocks: bool) -> Self {
        Object { x, y, char, color, name: name.into(), blocks, alive: false,
                 fighter: None, ai: None, item: None, always_visible: false,
    ...
    pub fn equip(&mut self, log: &mut Vec<(String, Color)>) {
        ...
        if let Some(ref mut equipment) = self.equipment {
            if !equipment.equipped {
                ...
                log.add(format!("Equipment {} on {}.", self.name, equipment.slot),
                        colors::LIGHT_GREEN);
            }
        } else {
...
fn monster_death(monster: &mut Object, game: &mut Game) {
    ...
    game.log.add(format!("{} is dead! You gane {} experience points.",
...
fn toggle_equipment(inventory_id: usize, _objects: &mut [Object],
             ...
             _tcod: &mut Tcod) -> UseResult
{
    // heal the player
    let player = &mut objects[PLAYER];
    let heal_amount = (player.max_hp(game) / 4) as i32;
...
fn cast_lightning(_inventory_id: usize, objects: &mut [Object],
                  ...
                  -> UseResult
{
    // find closes enemy (inside a maximum range) and damage it
...
// This function will take a rect and place it in the map, making the tiles empty
...
// This function will create a horizontal tunnel between rooms
...
// This function will create a vertical runnel between rooms
...
fn make_map(objects: &mut Vec<Object>, level: u32) -> Map {
    ...
    // NOTE: works only when thep layer is the first object!
...
fn place_objects(room: Rect, map: &Map, objects: &mut Vec<Object>, level: u32) {
    ...
    for _ in 0..num_monsters {
        ...
        // only place if if the tile is not blocked
        if !is_blocked(x, y, map, objects) {
            let mut monster = match monster_choice.ind_sample(&mut rand::thread_rng()) {
                "orc" => {
                    // create an orc
                    let mut orc = Object::new(x, y, 'o', "Orc",
                                            colors::DESATURATED_GREEN, true);
                    orc.fighter = Some(Fighter{ base_max_hp: 20, hp: 20,
                                                base_defense: 0, base_power: 4,
                ...
                "troll" => {
                    ...
                    troll.fighter = Some(Fighter{ base_max_hp: 30, hp: 30,
                                                  base_defense: 2, base_power: 8,
                                                  on_death: DeathCallback::Monster,
                                                  xp: 100 });
        ...
        for _ in 0..num_items {
            ...
            if !is_blocked(x, y, map, objects) {
                let mut item = match item_choice.ind_sample(&mut rand::thread_rng()) {
                    ...
                    Item::Lightning => {
                        // create lightning bold scroll (10% chance)
                    ...
                    Item::Sword => {
                        // create a sword
                        let mut object = Object::new(x, y, '/', "sword",
                                                     colors::SKY, false);
                    ...
                    Item::Shield => {
                        // create a shield
                        let mut object = Object::new(x, y, '[', "shield",
                                                     colors::DARKER_ORANGE, false);
              ...
              fov_recompute: bool)
{
    ...
    tcod.panel.print_ex(1, 3, BackgroundFlag::None, TextAlignment::Left,
                        format!("Dungon level: {}", game.dungeon_level));
...
fn handle_keys(key: Key, tcod: &mut Tcod, game: &mut Game,
    ...
    match (key, player_alive) {
        ...
        (Key { code: NumPad5, .. }, true) => {
            TookTurn // do nothing, ie wait for the monster to come to you
        }
        ...
        (Key { printable: 'c', .. }, true) => {
            ...
            if let Some(fighter) = player.fighter.as_ref() {
                let msg = format!("Character information 
                                  ...
                                  Maximum HP: {} 
                                  Attack: {} 
                                  Defense: {}", level, fighter.xp, level_up_xp,
...
fn new_game(tcod: &mut Tcod) -> (Vec<Object>, Game) {
    ...
    player.alive = true;
    player.fighter = Some(Fighter{ base_max_hp: 100, hp: 100, base_defense: 1,
                                   base_power: 2,
...
fn play_game(objects: &mut Vec<Object>, game: &mut Game, tcod: &mut Tcod) {
    // Force FOV to recompute first game loop
...
fn main_menu(tcod: &mut Tcod) {
    let img = tcod::image::Image::from_file("menu_bg.png")
